          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <label className="flex items-center gap-1" title={t('strokeWidth')}>
              ...
              <input
                ...
                className="w-10 rounded border border-teal-300 bg-[var(--deck-glass-fill-strong)] px-1 py-0.5 text-[10px] text-teal-700 focus:outline-none dark:border-teal-800 dark:text-teal-300"
              />
            </label>
          </div>
          <button
